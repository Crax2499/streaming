...
class ModeloPantalla{
	...
	static public function mdlRegistroPantalla($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_cuenta, cliente, pantalla, pass, fecha_corte, fecha_termino, telefono, costo, renovo_cuenta, estado, renovo_regresa, fecha) VALUES (:id_cuenta, :cliente, :pantalla, :pass, :fecha_corte, :fecha_termino, :telefono, :costo, :renovo_cuenta, :estado, :renovo_regresa, :fecha)");
	...
	static public function mdlEditarPantalla($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_cuenta = :id_cuenta, fecha_termino = :fecha_termino, fecha_corte = :fecha_corte, costo = :costo, cliente = :cliente, telefono = :telefono, pantalla = :pantalla, pass = :pass WHERE renovo_cuenta = :renovo_cuenta");
	...
	static public function mdlRenovarPantalla($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_cuenta = :id_cuenta, fecha_termino = :fecha_termino, fecha_corte = :fecha_corte, costo = :costo, cliente = :cliente, telefono = :telefono, pantalla = :pantalla, pass = :pass, renovo_cuenta = :renovo_cuenta, renovo_regresa = :renovo_regresa WHERE id = :id");
