...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, usuario, carpeta, password, email, perfil, foto, telefono, estado) VALUES (:nombre, :usuario, :carpeta, :password, :email, :perfil, :foto, :telefono, :estado)");
