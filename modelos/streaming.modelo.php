...
class ModeloStreaming{
	...
	static public function mdlRegistroStreaming($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, pantallas, estado) VALUES (:nombre, :pantallas, :estado)");
	...
	static public function mdlEditarStreaming($tabla, $datos){	
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, pantallas = :pantallas WHERE id = :id");
