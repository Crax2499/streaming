...
if(localStorage.getItem("capturarRango3") != null){
  ...
  $("#daterange-btn3 span").html(' Rango de fecha')
}
...
$('#daterange-btn3').click(function(){
  $(".daterangepicker.opensleft").addClass("opencombos");
});
...
$('#daterange-btn3').daterangepicker(
  ...
  function (start, end) {
    ...
    window.location = "index.php?ruta=reporte-combos&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
  }
)
...
=============================================*/
$(document).on("click",".opencombos .range_inputs .cancelBtn", function(){
  localStorage.removeItem("capturarRango3");
  localStorage.clear();
  window.location = "reporte-combos";
})

/*=============================================
CAPTURAR HOY
=============================================*/
$(document).on("click",".opencombos .ranges li", function(){
