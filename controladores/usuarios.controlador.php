				...
				if($_FILES["nuevaFoto"]["tmp_name"] == ""){
					...
					if(isset($_FILES["nuevaFoto"]["tmp_name"])){
						...
						if($_FILES["nuevaFoto"]["type"] == "image/jpeg"){
							...
							$ruta = "public/img/usuarios/".$_POST["nuevoUsuario"]."/".$aleatorio.".jpg";
						...
						if($_FILES["nuevaFoto"]["type"] == "image/png"){
							...
							=============================================*/
							$aleatorio = mt_rand(100,999);
							$ruta = "public/img/usuarios/".$_POST["nuevoUsuario"]."/".$aleatorio.".png";
		...
		if(isset($_POST["editarUsuario"])){
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"])){
				...
				if(isset($_FILES["editarFoto"]["tmp_name"]) && !empty($_FILES["editarFoto"]["tmp_name"])){
					...
					CREAMOS EL DIRECTORIO DONDE VAMOS A GUARDAR LA FOTO DEL USUARIO
					=============================================*/
					$directorio = "public/img/usuarios/".$_POST["editarCarpeta"];
					...
					if($_FILES["editarFoto"]["type"] == "image/jpeg"){
						...
						=============================================*/
						$aleatorio = mt_rand(100,999);
						$ruta = "public/img/usuarios/".$_POST["editarCarpeta"]."/".$aleatorio.".jpg";
					...
					if($_FILES["editarFoto"]["type"] == "image/png"){
						...
						=============================================*/
						$aleatorio = mt_rand(100,999);
						$ruta = "public/img/usuarios/".$_POST["editarCarpeta"]."/".$aleatorio.".png";
	...
	static public function ctrBorrarUsuario(){
		if(isset($_GET["idUsuario"])){
			...
			if($_GET["fotoUsuario"] != ""){
				...
				rmdir('public/img/usuarios/'.$_GET["usuario"]);
			}
